...
public class UsrArticleController {
	...
	public ResultData doDelete(int id) {
		...
		return ResultData.from("S-1", Ut.f("%d번 게시글이 성공적으로 삭제 되었습니다.", id));
	}
	...
	public ResultData getArticles() {
		...
		int idNum = articleService.getArticlenum();
		
		return ResultData.from("S-1", Ut.f("%d개의 게시글이 있습니다", idNum), Articles);
	}
}